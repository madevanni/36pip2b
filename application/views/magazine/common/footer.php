<footer id="footer">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6">
            <div class="single_footer_top wow fadeInLeft">
                ...
                <ul class="catg3_snav ppost_nav">
                    <li>
                        <div class="media"> <a class="media-left" href="pages/single_page.html"> <img src="<?php ((isset($cssRelative)) ? print $cssRelative : ""); ?>assets/magazine/images/70x70.jpg" alt=""> </a>
                    ...
                    <li>
                        <div class="media"> <a class="media-left" href="#"> <img src="<?php ((isset($cssRelative)) ? print $cssRelative : ""); ?>assets/magazine/images/70x70.jpg" alt=""> </a>
                            <div class="media-body"> <a class="catg_title" href="#"> Aliquam malesuada diam eget turpis varius</a></div>
                        </div>
                    </li>
                </ul>
    ...
    <div class="footer_bottom">
        <div class="footer_bottom_left">
            <p>Copyright &copy; 2016 PIP2B Propinsi Banten</p>
        </div>
