        ...
        <div id="container">
            ...
            <div id="body">
                <?php if ($images->num_rows() > 0) : ?>
                    ...
                    <?php endif; ?>
                    <div align="center">
                        <?= anchor('galleri/add', 'Add a new image', ['class' => 'btn btn-primary']) ?>
                    </div>
                    <hr />
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p>
                                            <?= anchor('galleri/edit/' . $img->id, 'Edit', ['class' => 'btn btn-warning', 'role' => 'button']) ?>
                                            <?= anchor('galleri/delete/' . $img->id, 'Delete', ['class' => 'btn btn-danger', 'role' => 'button', 'onclick' => 'return confirm(\'Are you sure?\')']) ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <?php else : ?>
                    <div align="center">
                        We don't have any image yet, go ahead and <?= anchor('galleri/add', 'add a new one') ?>.
                    </div>
                <?php endif; ?>
            </div>
